...
int main(int argc, char **argv){
    ...
    const char *outAssign   = (argc>5)? argv[5] : "assign.csv";     // valor padrão
    const char *outCentroid = (argc>6)? argv[6] : "centroids.csv";  // valor padrão
